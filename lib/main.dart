      ...
      home: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            ...
            ), // ปรับความมืดของภาพพื้นหลังให้มืดลง
          ),
        ),
        child: Scaffold(
          ...
          body: Column(
            children: [
              ...
              ), // เว้นระยะห่างระหว่างรูปโปรไฟล์และข้อความ
              const ListTile(
                title: Text(
                  "Name: Waritthon Santikarn",
              ...
              const ListTile(
                title: Text(
                  "Education: Kasetsart University, Information Technology(IT)",
                  style: TextStyle(fontSize: 16, color: Colors.white),
                ),
                leading: Icon(
                  Icons.school,
              ...
              const ListTile(
                title: Text(
                  "Address: 16/59, Ban Pong, Ratchaburi, 70110",
                  style: TextStyle(fontSize: 16, color: Colors.white),
                ),
                leading: Icon(
                  Icons.location_on,
